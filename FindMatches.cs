...
public class FindMatches : MonoBehaviour
{
                ...
                if(currentDot != null)
                {
                    ...
                    if(i > 0 && i < board.width - 1)
                    {
                        ...
                        if(leftDot != null && rightDot != null)
                        {
                            ...
                            {  
                            //Horizontal
                            //Makes column bomb work for center,left and right pieces
                    ...
                    if(j > 0 && j < board.height - 1)
                    {
                        ...
                        if(upDot != null && downDot != null)
                        {
                            ...
                            {
                            //Vertical
                            //Makes column bomb work for center,up and down pieces
    ...
    List<GameObject> GetAdjacentPieces(int column, int row)
    {
        ...
        for (int i = column - 1; i <= column + 1; i++)
        {
            for(int j = row - 1; j <= row + 1; j++)
            {
                ...
                {
                    if(board.allDots[i,j] != null)
                    {                                       //I ADDED THIS IF STATEMNT TO FIX BLANK SPACE PROBLEM WITH ADJACENT BOMBS -SELF ADDED
    ...
    //HELPER FUNCTIONS FOR ROW AND COLUMN BOMBS
        ...
        for (int i = 0; i < board.height; i++)
        {
            if(board.allDots[column, i] != null)
            {
                ...
                if(dot != null)
                {
                    if(dot.isRowBomb)
                    {
                        //If there is a column bomb in this row then call method "GetColumPieces" to also get all the column pieces and destroy them , aka chaining bombs and same goes for the above method 
